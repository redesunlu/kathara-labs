...
from scapy.all import Ether, sniff, conf, get_if_hwaddr
import sys
...
def procesar_trama(paquete):
	...
	Analiza y muestra los campos de la trama Ethernet solo si es para 
	este host.
	"""
...
def escuchar_tramas():
	...
	print("=" * 60)
	print("Escuchando tramas Ethernet (Capa 2) para:", my_mac)
	print("=" * 60)
	...
	filtro = "ether broadcast or ether dst " + my_mac
	print (filtro)
	# Opciones:
